...
from pretrained.unimodal.eog.data_loader import TorchDataset
...
def get_args():
    ...
    parser.add_argument('--ch_names', default=['EOG_Left', 'EOG_Right'], choices=['EEG_C4', 'EEG_C3',
                                                                                  'EOG_Left', 'EOG_Right',
    ...
    parser.add_argument('--ckpt_name', default='eog', type=str)
